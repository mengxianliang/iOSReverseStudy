#if __has_include(<XCTestCore/XCTestObservation.h>)
#import <XCTestCore/XCTestObservation.h>
#else
...
/*!
 * @method -testSuite:didRecordExpectedFailure:
 *
 * Sent when a test suite records an expected failure.
 *
 * @param testSuite The test suite that recorded the expected failure.
 * @param expectedFailure Object with all details related to the expected failure, including the suppressed issue.
 */
...
/*!
 * @method -testCase:didRecordExpectedFailure:
 *
 * Sent when a test case records an expected failure.
 *
 * @param testCase The test case that recorded the expected failure.
 * @param expectedFailure Object with all details related to the expected failure, including the suppressed issue.
 */
...
- (void)testSuite:(XCTestSuite *)testSuite didFailWithDescription:(NSString *)description inFile:(nullable NSString *)filePath atLine:(NSUInteger)lineNumber
    XCT_DEPRECATED_WITH_REPLACEMENT("testSuite:didRecordIssue:")
    XCT_DEPRECATED_WITH_SWIFT_REPLACEMENT("testSuite(_:didRecord:)");
...
- (void)testCase:(XCTestCase *)testCase didFailWithDescription:(NSString *)description inFile:(nullable NSString *)filePath atLine:(NSUInteger)lineNumber
    XCT_DEPRECATED_WITH_REPLACEMENT("testCase:didRecordIssue:")
    XCT_DEPRECATED_WITH_SWIFT_REPLACEMENT("testCase(_:didRecord:)");
