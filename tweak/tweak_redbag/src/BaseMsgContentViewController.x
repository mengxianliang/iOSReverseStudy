...
@class MessageTipView, MMNewMsgContentNavBar, MMMsgContentNavBar, ChatRoomHistoryShareStat, MMInputMsgReferView, MMRichTextCoverView, BadRoomLogicController, MMInputToolView, MMTimer, RichTextView, MMPageSheetAdapter;
...
- (void)setTableCellUpdateSeq:(unsigned long long )tableCellUpdateSeq { %log; %orig; }
- (unsigned long long )tableCellUpdateSeq { %log; unsigned long long  r = %orig; NSLog(@" = %llu", r); return r; }
- (void)setTableReloadSeq:(unsigned long long )tableReloadSeq { %log; %orig; }
- (unsigned long long )tableReloadSeq { %log; unsigned long long  r = %orig; NSLog(@" = %llu", r); return r; }
...
- (void)setMultiSelectedHandler:(int)arg1 { %log; %orig; }
- (void)setMultiSelectedChecker:(int)arg1 { %log; %orig; }
- (void)handleMultiSelectWithScrollDirection:(_Bool)arg1 { %log; %orig; }
- (void)tryUpdateHotAreaVisibleCellTo:(_Bool)arg1 { %log; %orig; }
...
- (double)getPageSheetModeBottomPadding { %log; double r = %orig; NSLog(@" = %f", r); return r; }
...
- (double)getContentViewY { %log; double r = %orig; NSLog(@" = %f", r); return r; }
...
- (id)getPageSheetContainerViewController { %log; id r = %orig; NSLog(@" = %@", r); return r; }
- (void)setIsPageSheetSessionWillRestore:(_Bool)arg1 { %log; %orig; }
- (_Bool)isPageSheetSessionWillRestore { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
...
- (void)onActivityIndicatorEndAnimating { %log; %orig; }
- (void)onActivityIndicatorStartAnimating { %log; %orig; }
- (void)MMUIViewControllerDidBeDismissed:(id)arg1 { %log; %orig; }
- (void)onAppTaskDidRestoreIntermediatePageWhenLaunchWithAppId:(id)arg1 { %log; %orig; }
- (void)onAppTaskWillRestoreIntermediatePageWhenLaunchWithAppId:(id)arg1 { %log; %orig; }
...
- (void)setPageSheetAdapter:( MMPageSheetAdapter *)pageSheetAdapter { %log; %orig; }
- ( MMPageSheetAdapter *)pageSheetAdapter { %log;  MMPageSheetAdapter * r = %orig; NSLog(@" = 0x%llx", (uint64_t)r); return r; }
...
- (_Bool)shouldShowQuickReplyPush:(id)arg1 { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
